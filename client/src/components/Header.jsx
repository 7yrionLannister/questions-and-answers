        ...
        <div className='flex items-center bg-white sticky z-50 shadow-sm top-0 justify-center p-[3px]'>
            ...
            <div className='flex items-center ml-[25px]'>
                ...
                <button
                    ...
                    className='px-2 py-1 rounded-lg ml-1 bg-orange-300 hover:bg-orange-500'
                >
                    Add Question
                </button>
                <Modal
                ...
                >
                    <div className='flex items-center mb-2 border-b-2 border-solid border-gray-800/5 rounded-md'>
                        <h5 className='text-orange-400 text-lg cursor-pointer font-semibold mr-[30px]'>
                            Add Question
                        </h5>
                        <h5 className='text-orange-400 text-lg cursor-pointer font-semibold mr-[30px]'>
                            Share Link
                    ...
                    <div className='flex flex-col-reverse mt-2 items-center'>
                        ...
                        <button
                            ...
                            type='submit'
                            className='mt-2 border-none outline-none text-orange-500 text-bold p-2 rounded-3xl cursor-pointer hover:text-orange-800 w-1/2'
                        >
                            Add Question
                        </button>
                    </div>
